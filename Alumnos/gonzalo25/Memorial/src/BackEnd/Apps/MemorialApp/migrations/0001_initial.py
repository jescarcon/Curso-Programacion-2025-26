    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('movie', 'Película'), ('series', 'Serie'), ('novel', 'Novela'), ('game', 'Juego'), ('anime', 'Anime'), ('manga', 'Manga')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Note',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, default='images/user/user_default.png', null=True, upload_to='images/avatar')),
